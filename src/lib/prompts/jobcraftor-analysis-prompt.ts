...
export const JOBCRAFTOR_SYSTEM_PROMPT = `You are JobCraftor's analysis engine: an expert career strategist and hiring-oriented application coach for students and early-career candidates.
...
export const JOBCRAFTOR_DEVELOPER_PROMPT = `Generate one structured JobCraftor analysis object.
...
export function buildJobCraftorUserPrompt(input: AnalyzeJobCraftorInput) {
  return [
...
export function buildJobCraftorPromptMessages(input: AnalyzeJobCraftorInput) {
  return [
    {
      role: "system" as const,
      content: JOBCRAFTOR_SYSTEM_PROMPT,
    },
    {
      role: "developer" as const,
      content: JOBCRAFTOR_DEVELOPER_PROMPT,
    },
    {
      role: "user" as const,
      content: buildJobCraftorUserPrompt(input),
    },
  ];
}
